...
export default function App() {
  ...
  var LTVstring2 = "• Your Loan-to-Value ratio is too high. Consider increasing your down payment. In order to purchase this home, you must also purchase Private Mortgage insurance. You would pay a monthly amount of $";
  ...
  useEffect(() => {
    const getPMI = () => {
      let myPMI = ((appraisedValue * 1.01)/12).toFixed(2);
  ...
  return (
    <main>
      ...
      <label>Calculated Loan-to-Value Ratio: {LTV*100}%</label>
      <br />

      <label>Calculated Debt-to-Income Ratio: {DTI*100}%</label>
      <br />

      <label>Calculated Front-End Debt-to-Income Ratio: {FEDTI*100}%</label>
      <br />
